...
//            }
//        }
//        static Dictionary<string, FileManifestEntry> LoadManifest(string manifestPath)
//        {
//            if (!File.Exists(manifestPath))
//                return new Dictionary<string, FileManifestEntry>(StringComparer.OrdinalIgnoreCase);

//            try
//            {
//                string json = File.ReadAllText(manifestPath);
//                return JsonSerializer.Deserialize<Dictionary<string, FileManifestEntry>>(json)
...
//        static void SaveManifest(string manifestPath, Dictionary<string, FileManifestEntry> state)
//        {
//            try
//            {
...
//            catch (Exception ex)
//            {
//                PrintError($"Failed to save manifest: {ex.Message}");
//            }
//        }
...
//            string manifestPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, syncMetaFile);
//            var lastState = LoadManifest(manifestPath);
//            var currentState = new Dictionary<string, FileManifestEntry>(StringComparer.OrdinalIgnoreCase);
...
//                };
//                currentState[relativePath] = entry;

//                // new file or modified file
//                if (!lastState.TryGetValue(relativePath, out var meta) ||
//                    meta.Length != entry.Length ||
//                    meta.LastWriteTimeUtcTicks != entry.LastWriteTimeUtcTicks)
//                {
...
//            SaveManifest(manifestPath, currentState);
//        }
...
//                        if (Directory.GetLastWriteTimeUtc(clientFolder) > _lastSyncTime)
//                        {
//                            SyncFiles(clientFolder, correspondingServerFolder, logFilePath, "ClientToServer", excludeList, false);
//                        }

//                        if (Directory.GetLastWriteTimeUtc(correspondingServerFolder) > _lastSyncTime)
//                        {
